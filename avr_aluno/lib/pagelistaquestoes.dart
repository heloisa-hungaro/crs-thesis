...
class ListaQuestoes extends StatefulWidget {
  ...
  final professor;
  final listPlot;
  ListaQuestoes({this.turma, this.professor, this.listPlot});

  @override
  State<StatefulWidget> createState() => ListaQuestoesState(
      turma: turma, professor: professor, listPlot: listPlot);
}

class ListaQuestoesState extends State<ListaQuestoes> {
  List<Tuple2> listPlot;
  String turma;
  String professor;
  ListaQuestoesState({this.turma, this.professor, this.listPlot});
